...
def get_color_accounting(kwargs):
    try:
        ...
        banner_data = frappe.get_all("Banner",filters={"banner_name":"COLOR ACCOUNTING LEARNING SYSTEM"},fields=["banner_name","banner_background_image","banner_text_image","banner_text","banner_height","banner_font_size","banner_alignment"])
        ...
        industries_imgs = frappe.get_all("Industry Images",fields=["industry_image"], order_by="sequence")
        recognized_universities_description = color_accounting.recognized_universities_description 
        recognized_universities_image = frappe.get_all("Recognized Universities Images",fields=["university_image"])
