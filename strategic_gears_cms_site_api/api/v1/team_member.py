...
def get_team_member(kwargs):
    try:
        ...
        banner = frappe.get_all("Banner", filters= {"banner_name": "OUR TEAM"}, fields=["banner_name","banner_text","banner_background_image","banner_height","banner_font_size","banner_alignment"])
